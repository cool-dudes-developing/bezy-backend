<template>
    ...
    >
        <div
            v-if="backdropOpen"
            class="fixed inset-0 flex items-end overscroll-contain z-50 pt-8"
...
const emit = defineEmits(['close', 'closing', 'update:open'])
...
function onBackdropClick() {
    if (props.backdrop) emit('update:open', false)
}
